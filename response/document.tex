...
cooperative. Nevertheless, cooperative transmission has both attacted great
research interest [10][11] and been incorporated into the latest wireless
communication systems such as LTE-advanced~\citep[R][]{TR36.819}. The simplicity
of this model allows it to be adopted to many scenarios, such as joint
transmission between different sectors/cells from a same macro base station
(BS), between homogeneous cells covered by a macro BS and its high-power RRHs,
or between heterogeneous cells covered by a macro BS and its low-power RRHs, etc. Recent sudies on Cloud Radio Access Network
...
If there are $N>2$ RRHs cooperating with one another, it is possible to
scale our MoDiv design approach into a quadratic $(N+1)$-dimensional
assignment problem at the cost of fast-growing complexity. However, in reality,
...
practical to investigate only two or three transmitters cooperating
