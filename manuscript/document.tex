...
0$, where $\psi_0[\cdot]\in\mathcal{C}$ represents Gray mapping. Apparently,
$\psi_1^{(m)}$ and $\psi_2^{(m)}$ are defined by the 1st, 2nd and 1st, 3rd
dimension of $\mathbf{x}^{(m)}$, respectively. We have
...
For typical constellations such as
